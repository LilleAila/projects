function board_extrude_1_6_outline_fn(){
    return new CSG.Path2D([[89,-110.5],[89,-72.5]]).appendPoint([342,-72.5]).appendPoint([342,-110.5]).appendPoint([270,-110.5]).appendPoint([270,-144.5]).appendPoint([161,-144.5]).appendPoint([161,-110.5]).appendPoint([89,-110.5]).close().innerToCAG()
