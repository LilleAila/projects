"""
Oppgave 2. Flerre runder, skrive fil.
Jeg valgte også å stokke litt om på hvor de ulike komponentene vises.
"""
...
class Game:
    ...
    def __update(self) -> None:
        if self.__game_running:
            ...
            self.__bg = (randint(0, 80), randint(0, 80), randint(0, 80))
            self.__score = 0
            self.__time.time = 0
